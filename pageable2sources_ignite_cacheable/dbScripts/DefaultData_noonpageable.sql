...
insert into client (id, name, birthday, active, country_id)
  values (nextval('client_seq'), 'Vinicius Antonio Gai_Nonpageable', to_date('19881112','YYYYMMDD'), true, 1);
insert into client (id, name, birthday, active, country_id)
  values (nextval('client_seq'), 'Frédéric Chopin_Nonpageable', to_date('18100301','YYYYMMDD'), true, 2);
insert into client (id, name, birthday, active, country_id)
  values (nextval('client_seq'), 'Jerzy Kosiński_Nonpageable', null, true, 2);
insert into client (id, name, birthday, active, country_id)
  values (nextval('client_seq'), 'Marie Bashkirtseff_Nonpageable', null, false, 3);
insert into client (id, name, birthday, active, country_id)
